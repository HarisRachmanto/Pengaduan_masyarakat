...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
                ...
                <img src="{{ asset('assets/images/logo.png') }}" alt="" height="20px" class="mt-3">
        </a>
    ...
    <ul class="menu-inner py-1 mt-5">
        ...
        <li class="menu-item {{ Route::is('akunmasyarakat') ? 'active' : ''}}">
            <a href="{{ route('akunmasyarakat') }}" class="menu-link">
        ...
        <li class="menu-item">
            <a href="{{route('petugas.logout')}}" class="menu-link">
